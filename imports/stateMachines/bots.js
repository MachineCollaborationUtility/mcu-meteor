const pauseable = ['executingJob', 'blocking', 'blocked', 'unblocking'];

const processingJob = ['startingJob', 'pausing', 'paused', 'resuming', ...pauseable];

const connected = ['idle', 'completingJob', 'cancelingJob', ...processingJob];

const available = ['ready', 'connecting', 'disconnecting', 'error', ...connected];
